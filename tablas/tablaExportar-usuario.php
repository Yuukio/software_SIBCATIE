...
<div style="padding-left: 20px">
    <table id="tabla-favoritos" class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            $sql = "SELECT planta.idPlanta, planta.idMascara, genero.nombre_genero, epiteto.nombre_epiteto, familia.nombre_familia FROM exportar
                    LEFT JOIN (planta 
                    ...
                    WHERE exportar.Usuario_idUsuario='$usuario'";
